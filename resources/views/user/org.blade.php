                    ...
                    <div class="d-flex justify-content-center">
                        <form class="col-sm-7">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" value="" id="horizontal-email-input">
                                </div>
                            </div>
                ...
                return `
                    <div style="padding-top:30px;background-color:none;margin-left:1px;height:${
                        ...
                        <div style="display:flex;justify-content: center;padding-left:15px;padding-right:15px;margin-top: 25px;">
                            <a href="/adduser/param/${d.data.parent_id}/${d.data.position}" class="btn btn-outline-primary w-sm">สมัครตำแหน่งนี้</a>
                    ...
                    <div class="card-chard">
                        <div class="card text-center">
                            <div class="card-body">
                                ...
                                <a href="/adduser/param/` + data['parent_id'] + `/` + data['position'] + `" class="btn btn-primary btn-rounded waves-effect waves-light">สมัครตำแหน่งนี้</a>
                            </div>
