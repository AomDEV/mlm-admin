...
@section('title') Company - Wallet   @endsection
@section('css')
    <!-- DataTables -->
...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @slot('title') Company - Wallet   @endslot
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="from" id="from" class="form-control datepicker"
                                data-provide="datepicker" placeholder="จากวันที่">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="to" id="to" class="form-control datepicker"
                                data-provide="datepicker" placeholder="ถึงวันที่">
                        </div>
...
@section('script')
    ...
    <script>
        ...
        function filter1() {
            ...
            $.post("{{  route('company-wallet.search')  }}", data = {
                    _token: '{{ csrf_token() }}',
                    from: from,
                    to: to,
                    type: type,
