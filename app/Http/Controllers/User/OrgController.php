...
class OrgController extends Controller
{
    ...
    public function uplineListInfo(Request $request){
        $user = UserModel::with('product')->where('id', $request->input('id'))->first();
        if($user){
    ...
    public function uplineListInfoarray2(Request $request){
        $user = UserModel::with('product', 'childrenUpline')->where('id', $request->input('id'))->get();
    ...
    public function uplineListInfoarray(Request $request){
        ...
        $users = UserModel::with('product','childrenUpline')
    ...
    public function uplineList(Request $request){
        ...
        $start = $request->input('start');
        $end = $request->input('end');
        $users = UserModel::with('childrenUpline')
            // ->where('username', $username);
            ->where('id', $username);
