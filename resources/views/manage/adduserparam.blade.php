                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex">
                                        <input type="hidden" value="{{request()->position}}">
                                        <div class="form-check mb-3">
                                            <input class="form-check-input @error('position_space') is-invalid @enderror" type="radio" id="formRadios1" name="position_space" value="left" {{ request()->position == 'left' ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="formRadios1">
                                                ซ้าย
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input @error('position_space') is-invalid @enderror" type="radio" name="position_space" value="right" id="formRadios2" {{ request()->position == 'right' ? 'checked' : '' }} disabled>
