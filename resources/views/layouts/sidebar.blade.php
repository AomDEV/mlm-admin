            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{ route('admin.withdraw.index') }}" class="waves-effect">
                        <i class="bx bx-up-arrow-alt "></i> <span class="badge rounded-pill bg-danger float-end count-wait-withdraw" > </span>
                        <span key="t-calendar"> รายการขอถอนเงิน </span>
                    </a>
                </li>


                <li>
                    <a href="{{ route('admin.deposit.index') }}" class="waves-effect">
                        <i class="bx  bx-down-arrow-alt "></i> <span class="badge rounded-pill bg-danger float-end count-wait-deposit" > </span>
                        <span key="t-calendar"> รายการขอฝากเงิน </span>
                    </a>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-wall"> Wallet </span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('company-wallet.index') }}" key="t-crypto">ประวัติรายการ Company Wallet</a></li>
                        <li><a href="{{ route('cashHistoryIndex') }}" key="t-crypto">ประวัติรายการ Cash Wallet</a></li>
                        <li><a href="{{ route('coinHistoryIndex') }}" key="t-crypto">ประวัติรายการ Coin Wallet</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="bx bx-wallet"></i>
                        <span key="t-crypto"> รายงาน </span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('admin.report.summary-in-out.index') }}" key="t-crypto"> รายงานสรุปรายได้</a></li>
                        <li><a href="{{ route('admin.report.summary-transaction.index') }}" key="t-crypto"> รายงาน Transaction</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="{{ route('package.index') }}" class="waves-effect">
                        ...
                        <span key="t-package"> จัดการ Package </span>
                    </a>
                </li>
                <!-- อาจเปิดใช้ภายหลัง 
                <li>
                    <a href="{{ route('company-bank.index') }}" class="waves-effect">
                        <i class="bx bx-edit"></i>
                        <span key="t-package"> จัดการบัญชีสำหรับโอนเงินเข้า </span>
                    </a>
                </li>
                -->
                <li>
                    <a href="{{ route('additional-function.index') }}" class="waves-effect">
                        <i class="bx bx-edit"></i>
                        <span key="t-package"> จัดการ Function  </span>
                    </a>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-crypto"> จัดการข้อมูลสมาชิก </span>
                    </a>

                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('orgView') }}"  key="t-crypto">แผนผังทีม</a></li>
                        <li><a href="{{ route('userList') }}"  key="t-crypto">รายชื่อสมาชิก</a></li>
                        <li><a href="{{ route('addUserIndex') }}" key="t-crypto">ลงทะเบียนสมาชิกใหม่</a></li>
                        <li><a href="{{ route('member.upgrade') }}" key="t-crypto">อัพเกรดแพคเกจ</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="bx bx-group"></i>
                        <span key="t-crypto"> จัดการข้อมูลผู้ดูแล </span>
                    </a>

                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('adminList') }}" key="t-crypto">รายชื่อผู้ดูแล</a></li>
                        <li><a href="{{ route('addAdminIndex') }}" key="t-crypto">เพิ่มผู้ดูแล</a></li>
                    </ul>
                </li>
                <li>
                    <a href="{{ route('manageNews') }}" class="waves-effect">
                        <i class="bx bx-edit"></i>
                        <span key="t-crypto"> แก้ไขประกาศข่าวสาร </span>
                    </a>
                </li>
