...
class LogsController extends RollUpController
{
    ...
    public function InsertData(){
        $UserData = UserModel::select("id")->get();
        foreach($UserData as $User){
            ...
            $this->extractBalance($userId, $totalBalance, "โบนัสการจับคู่ ({$totalCouple} คู่)", "DEPOSIT_COUPLE");
        }
    }
    ...
    private $detailCouple = "โบนัสการจับคู่";
    ...
    public function insertKey($id, $pairId){
        ...
        $keyDetail = "โบนัสลงทะเบียนให้ #{$pairId}";
